      ...
      <footer className="footer footer-center rounded bg-base-200 p-10 text-base-content">
        <nav className="grid grid-flow-col gap-4">
          <a
            ...
            href="https://github.com/findingatime/findingatime"
          >
            Git Hub Repo
          </a>
          <a
            className="link-hover link"
            href="https://github.com/FindingATime/FindingATime/discussions/categories/announcements"
          >
            Contact
          </a>
          <a
          ...
          <dialog id="privacy_modal" className="modal">
            <div className="modal-box w-11/12  max-w-5xl text-left">
              ...
              <p>
                <strong>Last updated: September 17, 2024</strong>
              </p>
              <p>
              ...
              <h3 className="text-md font-bold">Interpretation</h3>
              <p>
              ...
              <h3 className="text-md font-bold">Definitions</h3>
              ...
              <ul className="list-disc pl-5">
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Finding A Time.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Finding A Time,
                    accessible from{' '}
                    <a
                      href="https://findingatime.com"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://findingatime.com
                    </a>
                  </p>
                </li>
                <li>
              ...
              <h3 className="text-md font-bold">Types of Data Collected</h3>
              <h4 className="text-sm font-bold">Personal Data</h4>
              <p>
              ...
              <h4 className="text-sm font-bold">Usage Data</h4>
              <p>
              ...
              <p>
                ...
                storage to track the activity on Our Service and store certain
              ...
              <h3 className="text-md font-bold">Use of Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-md font-bold">Delete Your Personal Data</h3>
              <p>
              ...
              <h2 className="text-md font-bold">Children&apos;s Privacy</h2>
              <p>
              ...
              <h2 className="text-md font-bold">Links to Other Websites</h2>
              <p>
              ...
              <ul className="list-disc pl-5">
                <li>
                  ...
                  <a
                    href="https://github.com/FindingATime/FindingATime/issues"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://github.com/FindingATime/FindingATime/issues
                  </a>
                </li>
              </ul>
