...
const userNameTooLong = "dbeast86dbeast86dbeast86dbeast86dbeast86dbeast86dbeast86dbeast86dbeast86dbeast86";
...
describe("Username component", () => {
  it("should present an error when username is longer than 40 characters", () => {
    ...
    // Act
    const editUserNameButton = userName.container.querySelector('#editUsernameBtn');
    ...
    // Assert
    expect(userName.getByText("Username must be between 1 and 40 characters long!")).toBeInTheDocument();
  });
})
